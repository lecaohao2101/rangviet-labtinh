...
/**
 * Trang chi tiết: ĐỐI TÁC RĂNG SỨ NACERE - Đang cập nhật
 */
export default function DoiTacRangSuNacerePage() {
      ...
      <div className="mx-auto max-w-4xl">
        ...
        >
          <ol className="flex items-center space-x-2 text-sm text-foreground-secondary">
            ...
            <li>/</li>
            <li className="text-foreground">ĐỐI TÁC RĂNG SỨ NACERE</li>
          </ol>
        </nav>
        ...
        >
          <div className="max-w-md mx-auto">
            ...
            <p className="text-lg text-foreground-secondary mb-8">
              Nội dung về <strong>ĐỐI TÁC RĂNG SỨ NACERE</strong> đang được chúng tôi cập nhật. Vui lòng quay lại sau!
            </p>
