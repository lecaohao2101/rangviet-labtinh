...
export default function Footer() {
  ...
  return (
    <footer className="bg-background-secondary border-t border-border text-foreground transition-colors duration-300">
            ...
            <nav className="flex flex-col space-y-2">
              {menuItems.map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className="text-sm text-foreground-secondary hover:text-primary transition-colors duration-200"
                >
                  {item.label}
                </Link>
              ))}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <a
                ...
                className="inline-flex items-center gap-2 text-sm text-foreground-secondary hover:text-primary transition-colors duration-200"
              >
                <svg
                  className="h-6 w-6"
                  fill="currentColor"
